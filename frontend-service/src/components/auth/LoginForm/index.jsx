      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '100%', maxWidth: '440px' }}>
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div className="form-group">
              <label className="form-label" htmlFor="email-input">Email Address / User ID</label>
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  placeholder="email@college.edu or Roll Number"
                  value={email}
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '0.75rem' }}>
            ...
            >
              <strong>College Admin:</strong> <span>admin@ics.edu</span>
            </button>
            <button
              onClick={() => handleAutofill('student', 'john.doe@student.edu')}
              style={{
            ...
            >
              <strong>Student:</strong> <span>john.doe@student.edu</span>
            </button>
          </div>
        </div>
      </div>
